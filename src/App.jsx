  ...
  return (
    <div className="finger-hands" ref={containerRef}>
      ...
      <div className="finger-hands-container">
        ...
        <svg viewBox="0 0 540.501 640.304" className="finger-hand-svg" style={{ transform: 'scaleX(-1)' }}>
          ...
          {[
            ...
            <circle key={finger} cx={cx} cy={cy} r="20"
          ...
          <circle cx={pos.thumb.cx} cy={pos.thumb.cy} r="20"
            fill={getColor('thumb')}
